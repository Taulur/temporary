    ...
    public partial class Form1 : Form
    {
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            /* string recevier = textBox2.Text;
             MailAddress from = new MailAddress("matuhazapominalkin@gmail.com", "Ìåíåäæåð");
             MailAddress to = new MailAddress(recevier);
             MailMessage m = new MailMessage(from, to);
             m.Subject = "Ïðèøëà íîâàÿ çàäà÷à";
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            if ((textBox6.Text.Length != 0) && (textBox5.Text.Length != 0))
            {
                ...
                ComboRefresh();
                MessageBox.Show("Êîíòàêò óñïåøíî äîáàâëåí");
            }
            else
            {
                MessageBox.Show("Äàííûå ââåäåíû íåâåðíî");
            }
        ...
        private async void button7_Click_1(object sender, EventArgs e)
        {
            if ((textBox1.Text.Length != 0) && (textBox7.Text.Length != 0) && (comboBox1.Text.Length != 0))
            {
                ...
                await bot.SendTextMessageAsync(id, "Íàçâàíèå : " + textBox1.Text + "\nÎòâåòñòâåííîñòü : " + comboBox1.Text + "\nÒåêñò çàäà÷è : " + textBox7.Text);
                MessageBox.Show("Çàäà÷à óñïåøíî ñîçäàíà");
            }
            else
            {
                MessageBox.Show("Äàííûå ââåäåíû íåâåðíî");
